...
export type PostalcodeResult = paths['/stations/postalcode']['get']['responses']['200']['content']['application/json; charset=utf-8'];

export type StatsOptions = paths['/stats']['get']['parameters']['query'];
export type StatsResult = paths['/stats']['get']['responses']['200']['content']['application/json; charset=utf-8'];
